...
function BMI_Calculator(cm, kg) {
  ...
  if (bmi < 18.5) {
    ...
    bmiResultIcon.src = "./Assets/images/weak.png"
    ...
    bmiResultIcon.src = "./Assets/images/normal.png"
    ...
    bmiResultIcon.src = "./Assets/images/overweight.png"
    bmiResultMessage.style.color = "#b43e56"
  }
  else if (bmi >= 30) {
    // obesity
    bmiResultMessage.innerHTML = "Obesity"
    bmiResultIcon.src = "./Assets/images/fat.png"
